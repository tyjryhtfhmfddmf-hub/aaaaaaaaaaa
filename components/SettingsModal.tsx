            ...
            <div className="bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-lg" onClick={e => e.stopPropagation()}>
                ...
                <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-3">
                    ...
                    <div>
                        ...
                        <h3 className="text-gray-300 font-medium mb-2 text-base uppercase tracking-wider">Updates</h3>
                        ...
                        <div className="p-3 bg-gray-700/50 rounded-lg">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                {updateStatus && <p className="text-sm text-gray-400 ml-4">{updateStatus}</p>}
