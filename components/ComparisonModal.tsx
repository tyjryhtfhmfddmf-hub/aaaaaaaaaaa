...
export const ComparisonModal: React.FC<ComparisonModalProps> = ({ isOpen, onClose, comparisonData }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800 rounded-lg shadow-2xl w-full max-w-4xl h-[90vh] flex flex-col text-gray-200">
                    ...
                    <div className="bg-gray-900/50 rounded-lg p-4 flex flex-col">
                        ...
                        <ul className="space-y-2 overflow-y-auto flex-1 pr-2">
                            {commonSongs.map(song => (
                                <li key={song.id} className="p-2 rounded-md bg-gray-800/60">
